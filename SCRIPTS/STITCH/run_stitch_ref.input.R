...
STITCH(outputdir = outputdir, 
	regenerateInput=FALSE, regenerateInputWithDefaultValues=TRUE, originalRegionName=chromosome_name,
	...
	tempdir = tempdir, K = Num_K, outputHaplotypeProbabilities=TRUE, output_haplotype_dosages=TRUE,
	reference_shuffleHaplotypeIterations=NA, 
	shuffleHaplotypeIterations = NA,
	refillIterations = NA, 
	nCores = Num_nCores, nGen = Num_nGen, method = Method)
       system( paste0( "rm -rf ", outputdir, "/input"))
